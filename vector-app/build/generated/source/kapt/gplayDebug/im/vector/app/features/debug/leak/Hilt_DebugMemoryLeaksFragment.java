...
public abstract class Hilt_DebugMemoryLeaksFragment<VB extends ViewBinding> extends VectorBaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DebugMemoryLeaksFragment_GeneratedInjector) this.generatedComponent()).injectDebugMemoryLeaksFragment(UnsafeCasts.<DebugMemoryLeaksFragment>unsafeCast(this));
    }
  }
