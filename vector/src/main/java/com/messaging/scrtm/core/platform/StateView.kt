...
import com.messaging.scrtm.core.extensions.updateConstraintSet
import com.messaging.scrtm.databinding.ViewStateBinding
    ...
    private fun update(newState: State) {
        ...
        when (newState) {
            ...
            is State.Empty -> {
                ...
                if (newState.titleFontSize > 0) {
                    views.emptyTitleView.textSize = newState.titleFontSize
                }
                if (newState.messageFontSize > 0) {
                    views.emptyTitleView.textSize = newState.messageFontSize
                }
            }
            is State.Error -> {
