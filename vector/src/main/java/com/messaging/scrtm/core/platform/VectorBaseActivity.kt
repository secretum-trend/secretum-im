...
package com.messaging.scrtm.core.platform
...
import com.messaging.scrtm.core.di.ActivityEntryPoint
import com.messaging.scrtm.core.dialogs.DialogLocker
...
import com.messaging.scrtm.core.extensions.observeEvent
import com.messaging.scrtm.core.extensions.observeNotNull
...
import com.messaging.scrtm.features.configuration.VectorConfiguration
import com.messaging.scrtm.features.consent.ConsentNotGivenHelper
...
import com.messaging.scrtm.features.rageshake.BugReportActivity
...
import com.messaging.scrtm.features.settings.VectorLocaleProvider
...
abstract class VectorBaseActivity<VB : ViewBinding> : AppCompatActivity(), MavericksView {
    ...
    private fun setFullScreen() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            ...
            window.statusBarColor = ContextCompat.getColor(this, com.messaging.lib.attachmentviewer.R.color.half_transparent_status_bar)
            // New API instead of FLAG_TRANSLUCENT_NAVIGATION
            window.navigationBarColor = ContextCompat.getColor(this, com.messaging.lib.attachmentviewer.R.color.half_transparent_status_bar)
        } else {
            @Suppress("DEPRECATION")
