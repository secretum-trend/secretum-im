...
package com.messaging.scrtm.core.ui.views
...
class ShieldImageView @JvmOverloads constructor(
     ...
     * @param roomEncryptionTrustLevel trust level that is usually calculated with [com.messaging.scrtm.features.settings.devices.TrustUtils.shieldForTrust]
