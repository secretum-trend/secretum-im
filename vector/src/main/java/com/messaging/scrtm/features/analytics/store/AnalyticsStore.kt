...
package com.messaging.scrtm.features.analytics.store
...
/**
 * Also accessed via reflection by the instrumentation tests @see [com.messaging.scrtm.ClearCurrentSessionRule].
 */
