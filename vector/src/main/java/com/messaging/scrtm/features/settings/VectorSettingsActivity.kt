...
import com.messaging.scrtm.databinding.ActivityVectorSettingsBinding
import com.messaging.scrtm.features.discovery.DiscoverySettingsFragment
import com.messaging.scrtm.features.navigation.SettingsActivityPayload
import com.messaging.scrtm.features.settings.devices.VectorSettingsDevicesFragment
import com.messaging.scrtm.features.settings.notifications.VectorSettingsNotificationPreferenceFragment
import com.messaging.scrtm.features.settings.threepids.ThreePidsSettingsFragment
            ...
            when (val payload = readPayload<SettingsActivityPayload>(SettingsActivityPayload.Root)) {
                ...
                SettingsActivityPayload.SecurityPrivacyManageSessions -> {
                    val fragmentClass = if (vectorPreferences.isNewSessionManagerEnabled()) {
                        com.messaging.scrtm.features.settings.devices.v2.VectorSettingsDevicesFragment::class.java
                    } else {
