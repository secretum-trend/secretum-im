...
import com.messaging.scrtm.core.dialogs.ManuallyVerifyDialog
import com.messaging.scrtm.core.extensions.registerStartForActivityResult
import com.messaging.scrtm.core.extensions.setTextColor
...
import com.messaging.scrtm.databinding.FragmentSettingsDevicesBinding
import com.messaging.scrtm.features.VectorFeatures
import com.messaging.scrtm.features.auth.ReAuthActivity
...
import com.messaging.scrtm.features.login.qr.QrCodeLoginType
import com.messaging.scrtm.features.settings.devices.v2.filter.DeviceManagerFilterType
import com.messaging.scrtm.features.settings.devices.v2.list.NUMBER_OF_OTHER_DEVICES_TO_RENDER
import com.messaging.scrtm.features.settings.devices.v2.list.OtherSessionsView
import com.messaging.scrtm.features.settings.devices.v2.list.SESSION_IS_MARKED_AS_INACTIVE_AFTER_DAYS
import com.messaging.scrtm.features.settings.devices.v2.list.SecurityRecommendationView
import com.messaging.scrtm.features.settings.devices.v2.list.SecurityRecommendationViewState
import com.messaging.scrtm.features.settings.devices.v2.list.SessionInfoViewState
import com.messaging.scrtm.features.settings.devices.v2.signout.BuildConfirmSignoutDialogUseCase
