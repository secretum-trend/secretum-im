...
import com.messaging.scrtm.features.onboarding.RegistrationStateFixture.aRegistrationState
import com.messaging.scrtm.features.onboarding.StartAuthenticationFlowUseCase.StartAuthenticationResult
import com.messaging.scrtm.test.TestBuildVersionSdkIntProvider
import com.messaging.scrtm.test.fakes.FakeActiveSessionHolder
import com.messaging.scrtm.test.fakes.FakeAnalyticsTracker
import com.messaging.scrtm.test.fakes.FakeAuthenticationService
import com.messaging.scrtm.test.fakes.FakeContext
import com.messaging.scrtm.test.fakes.FakeDirectLoginUseCase
import com.messaging.scrtm.test.fakes.FakeHomeServerConnectionConfigFactory
import com.messaging.scrtm.test.fakes.FakeHomeServerHistoryService
import com.messaging.scrtm.test.fakes.FakeLoginWizard
import com.messaging.scrtm.test.fakes.FakeRegistrationActionHandler
import com.messaging.scrtm.test.fakes.FakeRegistrationWizard
import com.messaging.scrtm.test.fakes.FakeSession
import com.messaging.scrtm.test.fakes.FakeStartAuthenticationFlowUseCase
import com.messaging.scrtm.test.fakes.FakeStringProvider
import com.messaging.scrtm.test.fakes.FakeUri
import com.messaging.scrtm.test.fakes.FakeUriFilenameResolver
import com.messaging.scrtm.test.fakes.FakeVectorFeatures
import com.messaging.scrtm.test.fakes.FakeVectorOverrides
import com.messaging.scrtm.test.fakes.toTestString
import com.messaging.scrtm.test.fixtures.a401ServerError
import com.messaging.scrtm.test.fixtures.aHomeServerCapabilities
import com.messaging.scrtm.test.fixtures.anUnrecognisedCertificateError
